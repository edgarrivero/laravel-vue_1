<template>
    <div class="panel panel-default">
        <div class="panel-heading">Publicado en - Última actualización: </div>

        <div class="panel-body">

            <input v-if="editMode" type="text" class="form-control" v-model="profesor.nombre">
...
<script>
    export default {
        ...
        methods: {
            onClickDelete() {
                axios.delete(`/thoughts/${this.profesor.id}`).then(() => {
                    this.$emit('delete');
                });
            },
            onClickEdit() {
